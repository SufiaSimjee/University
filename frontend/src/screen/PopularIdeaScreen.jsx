import { useGetPopularIdeasQuery } from '../slices/ideasApiSlice';
import { Card, Button, Badge } from 'react-bootstrap';
import { Link } from 'react-router-dom';
import Message from '../components/Message';
import Loader from '../components/Loader';

const PopularIdeasScreen = () => {
  const { data: popularIdeas, error, isLoading } = useGetPopularIdeasQuery();
...
export default PopularIdeasScreen;
