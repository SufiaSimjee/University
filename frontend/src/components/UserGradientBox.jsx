...
import { useGetUserIdeasCountQuery } from "../slices/reportSlice";  
...
const UserGradientBox = () => {
  const { data: userIdeasData, isLoading: ideasLoading, error: ideasError } = useGetUserIdeasCountQuery();
  ...
  return (
    <Container className="my-4">
      <Row className="g-4">
        <Col md={6} lg={4}>
          <StatCard
            title="Total Idea Posted"
            value={userIdeasData?.ideaCount || 0} 
...
export default UserGradientBox;